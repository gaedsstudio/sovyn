  ...
  return (
    <section className="rail section">
      <div className="section-heading">
        ...
        <p className="lead">
          Verified means publisher identity, source repository, release
          integrity, package manifest, and permission declarations have been
          reviewed. It does not mean malware-proof, risk-free, or permanently
          endorsed.
        </p>
      </div>
      <div className="grid">
